...
import {ReloadProvider} from '../../components/main/ReloadContext'
    ...
    return (
        <ReloadProvider>
            <div className='h-full bg-gray-900'>
                {/* Sidebar - left */}
                <div
                    className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col h-screen overflow-y-hidden">
                ...
                <div className="lg:pl-72 h-screen">
                    ...
                    <main className="flex flex-col">
                        ...
                        <div
                            className="fixed w-full bottom-0 flex bg-gradient-to-t from-gray-800 to-gray-800/0 justify-center lg:pr-72">
                            <ChatForm/>
                        </div>
                    </main>
                </div>
